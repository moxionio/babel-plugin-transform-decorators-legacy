    ...
    return {
        ...
        visitor: {
            ...
            ClassDeclaration: function ClassDeclaration(path) {
                ...
                path.replaceWith(t.variableDeclaration("let", [t.variableDeclarator(ref, t.callExpression(t.functionExpression(null, [], t.blockStatement([t.returnStatement(t.toExpression(node))])), []))]));
            },
